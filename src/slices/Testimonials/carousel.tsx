...
const Carousel = ({
  ...
  if (!isMounted) {
    return (
      <div className="relative w-full 2xl:max-w-[1440px] mt-[88px] flex h-[680px] w-[100%] items-start justify-center rounded-2xl bg-gradient-to-b from-white/[0.05] to-white/[0.15] outline outline-2 -outline-offset-[2px] outline-white/[12%] backdrop-blur-[50px] md:h-[521px] xl:mt-[80px]" />
    );
  }
      ...
      >
        {slice.items.map((item) => (
          ...
          >
            ...
            />
            <div className="mt-12 w-full text-center text-[21px] leading-[30.24px] tracking-[-0.21px] xl:w-[720px]">
            ...
            <div className="text-center text-base leading-[23.04px] tracking-[-0.16px] opacity-50 ">
